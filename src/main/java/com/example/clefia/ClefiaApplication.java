...
int[] clefia_s1 = {
    ...
    public void ClefiaF0Xor(Byte[] dst, Byte[] src, Byte[] rk)
    {
    ...
    private Byte[] getSubArray(Byte[] dst, int indice) {
    ...
    public void ClefiaF1Xor(Byte[] dst, Byte[] src, Byte[] rk)
    {
        int[] x = new int[4], y  = new int[4], z = new int[4] ;
