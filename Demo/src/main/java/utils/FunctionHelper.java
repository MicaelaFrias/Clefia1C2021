...
public class FunctionHelper {
    public static void addSpaceToList(List<Byte> dst, int length, int maxSize) {
    ...
    public static void printList(List<Byte> list, int length) {
        while (length > 0) {
    ...
    public static void fillLastList(List<Byte> toFill, List<Byte> pt) {
        int size = pt.size();
        int n = size % 16;
        int index = size - 1 - n;
